    ...
    <div className={styles.container}>
      <div className={styles.text}>
        <div className={styles.left}>
          <h1>
            Explore, Buy ,Sell <br /> and collect NFT arts.
          </h1>
        </div>
        <div className={styles.right}>
          <p>
            Modern Thirdweb NFT Marketplace. <br />
            Create your collection, Generate amazing art, <br /> Mint as NFT and
            list for sale.
          </p>
        </div>
      ...
      <div className={styles.gradient}>
        <img id={styles.astroRight} src="../shovel.png" alt="astronaut" />
        <img id={styles.astroLeft} src="../nftR.png" alt="astronaut" />
